...
describe("UI- und Mobile-UX-Regeln", () => {
  ...
  it("gibt in der Helferauswahl Neu-, Tages- und Konfliktstatus klar wieder", () => {
    ...
    expect(plan).toContain("data-feedback-conflict-label");
    expect(plan).toContain("data-day-state={segment.state}");
    ...
    expect(plan).toContain("bg-red-600 text-white line-through");
    expect(plan).toContain("bg-orange-100 text-orange-900");
    ...
    expect(plan).toContain("availability: dayAvailability.value");
    expect(plan).toContain('segment.state === "unavailable"');
    expect(plan).toContain("line-through");
    expect(plan).toContain("segment.state === \"conflict\"");
    ...
    expect(feedback).toContain('? "conflict"');
    expect(feedback).toContain("isCurrentDay");
