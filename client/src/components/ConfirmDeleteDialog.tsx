        ...
        <AlertDialogFooter className="flex-col sm:flex-row">
          ...
          <AlertDialogAction
            ...
            className={cn(
              ...
              "w-full min-w-[140px] border border-rose-200 !bg-rose-50 !text-rose-700 shadow-sm hover:!bg-rose-100 hover:!text-rose-800 disabled:!border-rose-100 disabled:!bg-rose-50 disabled:!text-rose-400 disabled:opacity-100 sm:w-auto"
            )}
            onClick={event => {
